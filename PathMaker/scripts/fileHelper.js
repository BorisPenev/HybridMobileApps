	...
	_createFile: function(fileSystem, fileName, text, onSuccess, onError) { 
		...
		fileSystem.root.getFile(fileName, options,
								function(fileEntry) {
                                    ...
                                    // this should fill up the information about the file after we choose to make it
                                    window.fileModel.title = fileName;
                                    window.fileModel.fileLocation = fileEntry.toURL;
								},
								function (error) {
